...
\draw [arrow] (dec2) |- node[anchor=west] {No} (pro6);
\draw [arrow] (dec4) |- node[anchor=west] {No} (pro7);
\draw [arrow] (pro1) |- node[anchor=south](pro2);
\draw [arrow] (pro6) |- node[anchor=south] (in2);
\draw [arrow] (pro7) |- node[anchor=south] (in3);
\end{tikzpicture}
    \end{figure}
